...
# In the packaged app (PyInstaller) there is no source tree, so look next to the executable;
# the file is optional there and system env vars are used as fallback.
